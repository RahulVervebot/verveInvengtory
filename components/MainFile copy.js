    ...
    <View style={styles.row}>
      ...
      <View style={styles.cell}>
        <RNPickerSelect
          ...
          value={item.category || ''} // Ensure value is never null
          style={{
          ...
          useNativeAndroidPickerStyle={false} // Customize the picker style
        />
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
          ...
          windowSize={21}
          removeClippedSubviews={true} // Improves memory consumption
...
const styles = StyleSheet.create({
  ...
  pickerIOS: {
    ...
    width: '100%', // Ensure the picker spans the full width of the cell
  },
  pickerAndroid: {
    height: 40,
    width: 100,
